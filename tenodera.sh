...
echo ""
echo "  This host's agent will appear under Management → Pending."
...
echo "  Then approve the host in the panel (Management → Pending)."
echo ""
echo "  For unattended installs, generate a bootstrap token in the panel (Management → Tokens)"
