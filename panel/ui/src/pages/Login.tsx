...
const styles: Record<string, React.CSSProperties> = {
  ...
  form: {
    ...
    gap: '1rem',
    padding: '2rem',
    background: 'color-mix(in srgb, var(--bg-panel) 92%, #A6E3A1)',
    borderRadius: '12px',
    border: '1px solid color-mix(in srgb, var(--border-1) 60%, transparent)',
    borderTop: '3px solid #A6E3A1',
    boxShadow: '0 8px 32px rgba(0,0,0,0.5), 0 0 40px -12px rgba(166,227,161,0.35)',
    width: '100%',
    maxWidth: '360px',
  },
  loginLogo: {
